...
function Tutorial() {
    ...
    // useEffect(async () => {
    //     await axios.get("/tutorial").then((res) => {
        ...
        <div className="tutorials__page">
            ...
            <div className="content__window">
                ...
                <div className="topic__desc">
                    ...
                    Quae praesentium blanditiis beatae sapiente voluptas,
                    expedita laudantium voluptatibus, sed quisquam consequuntur
                    officia, maiores sequi! Quo nostrum quia reiciendis
                    repellendus laudantium commodi.
                    <br />
                    <br />
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                    Aperiam distinctio placeat consequuntur doloremque ratione
                    repellat possimus reiciendis esse expedita maiores quas eos
                    rerum nisi, adipisci vero, nostrum dolorum sit voluptatum.
                </div>
                ...
                <div className="topic__desc">
                    <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Dolore fugiat tenetur nisi ducimus exercitationem a
                        quasi similique temporibus quibusdam.
                    </p>
                </div>
            </div>
        </div>
